...
import java.util.List;
    ...
    public class CartAdapter extends RecyclerView.Adapter<CartAdapter.MyViewHolder>{
        ...
        public CartAdapter(List<StoreItemsModel>list){
        ...
        public CartAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            com.example.design_patterns_shop.Adapter.CartAdapter.MyViewHolder viewHolder= new com.example.design_patterns_shop.Adapter.CartAdapter.MyViewHolder(v);
